...
for n = [1:100]
    ...
    ylabel('R0 as a Function of Mosquito:Bird', 'FontSize', 12);

%     figure_title=sprintf('R0 as a Function of Mosquito:Bird Ratio (disease impact = %.0f)',disease_impact);
%     title(figure_title);
%     file_name=sprintf('R0_tick_densityt=%.0f.eps');
