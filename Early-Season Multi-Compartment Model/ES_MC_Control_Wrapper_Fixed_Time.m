function [tau,ul,ua,X,J,J_comp,final_treatment_time,X0,T] = ES_MC_Control_Wrapper_Fixed_Time(N,Tf,Obj_type,larvicide)
...
if Obj_type==1
    [tau,ul,ua,X,J,J_comp,final_treatment_time,X0,T] =ES_MC_West_Nile_Control_Fixed_Times(N,Tf,larvicide);
end
if Obj_type==2
    [tau,ul,ua,X,J,J_comp,final_treatment_time,X0,T] = ES_MC_Control_Disease_Control_Fixed_Time(N,Tf,larvicide);
end
if Obj_type==3
