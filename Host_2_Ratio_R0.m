...
for n = 1:50
    ...
    j1(n) = omega2*p_hh2;
    j2(n) = (b*c_l(n)*m_l*p_hm2)/(c_h2*muV);
    j3(n) = b*p_mh;
    j4(n) = ri;

    n1(n) = (-d_h2*c_h2)-g2-gamma2-mu_h2;
    n2(n) = -m_e;
    n3(n) = m_e*phi*qi;
...
title('R0 as a Function of Mosquito:Bird Density for Host Group 2')
hold on

file_name=sprintf('R0_WNV_Host_2_Vector_Density_Ratio_Above_1.eps');
