...
%     j4(n) = ri;
% 
%     n1(n) = (-d_h1*c_h3)-g1-gamma1-mu_h1;
%     n2(n) = -m_e;
%     n3(n) = m_e*phi*qi;
...
% title('R0 as a Function of Mosquito:Bird Density')
% hold on
% 
% file_name=sprintf('R0_WNV_Host_Vector_Density_Ratio_Above_1.eps');
...
file_name=sprintf('R0_WNV_Host_Vector_Density_Ratio_Below_1.eps');
exportgraphics(gcf,file_name);
