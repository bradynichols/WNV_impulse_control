...
p(38) = max_ef*(p(8)+p(7))/(1-max_ef);
p(39)= -log(mid_ef*(1-max_ef)/((1-mid_ef)*max_ef))/mid_ef_day;

end

p(40)=24; % adulticide decay rate
p(41)=-log(0.1)*p(18)*2; % max rate at which adulticide kills adult vectors
